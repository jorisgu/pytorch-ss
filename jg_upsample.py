...
class FCN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fusion4 = Fusion(64)
        self.fusion5 = Fusion(64)
    ...
    def forward(self, x):
        ...
        fsfm1 = self.fusion1(fm3, self.upsample1(fm4, fm3.size()[2:]))
        out16 = self.out1(fsfm1)

        fsfm2 = self.fusion2(fm2, self.upsample2(fsfm1, fm2.size()[2:]))
        out8 = self.out2(fsfm2)

        fsfm3 = self.fusion4(pool_x, self.upsample3(fsfm2, pool_x.size()[2:]))
        # print(fsfm3.size())
        out4 = self.out3(fsfm3)

        fsfm4 = self.fusion5(conv_x, self.upsample4(fsfm3, conv_x.size()[2:]))
